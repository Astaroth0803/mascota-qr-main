<x-app-layout>
    <div class="min-h-screen bg-gray-50 pt-16 lg:pt-0">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                            ...
                            Solicitudes de Cambio de Citas
                        </h1>
                        <p class="text-sm text-gray-600 mt-2">Gestiona las solicitudes de cambio de fecha de tus clientes</p>
                    </div>
