...
@section('title', 'Solicitudes - Veterinario')
            ...
            <div class="py-4 lg:py-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1 min-w-0">
                        <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Solicitudes</h1>
                        <p class="text-sm text-gray-600 mt-1">Gestiona las solicitudes de atención veterinaria</p>
                    </div>
                    <!-- Acciones rápidas -->
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-orange-50 to-orange-100 px-6 py-4 border-b border-orange-200">
                            <h2 class="text-xl font-semibold text-gray-900 flex items-center">
                                ...
                                Solicitudes de Citas Pendientes ({{ $citasPendientes->count() }})
                            </h2>
    ...
    <script>
        ...
        function aceptarCita(citaId, nombreMascota, fechaSolicitada) {
            ...
            if (confirmacion) {
                ...
                fetch(`/dashboard/veterinario/solicitudes/citas/${citaId}/aceptar`, {
                    method: 'POST',
                    body: formData,
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
        ...
        function rechazarCita(citaId, nombreMascota) {
            ...
            if (razon && razon.trim() !== '') {
                ...
                fetch(`/dashboard/veterinario/solicitudes/citas/${citaId}/rechazar`, {
                    method: 'POST',
                    body: formData,
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
