...
@php
    $title = 'Mi Perfil';
    $subtitle = 'Administra tu información personal y configuración de administrador';
@endphp
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                            <div>
                                ...
                                <span class="text-gray-600 dark:text-gray-400 ml-2">{{ ucfirst($user->getRoleNames()->first()) }}</span>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <span class="text-gray-600 dark:text-gray-400 ml-2">{{ $user->getAllPermissions()->count() }} permisos</span>
                            </div>
                        </div>
                    </div>
                        </div>
                ...
                @if (session('status') === 'profile-updated')
                    <div class="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-green-800 dark:text-green-300">Perfil actualizado correctamente</p>
                            </div>
                        </div>
                    </div>
                @endif
        ...
        <div class="flex items-start">
            ...
            <div class="ml-4">
                ...
                <div class="space-y-2 text-sm text-blue-800 dark:text-blue-300">
                    ...
                    <p>• Mantén tu información actualizada para el correcto funcionamiento del sistema</p>
                </div>
            </div>
        </div>
    </div>
