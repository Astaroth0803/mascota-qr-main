                ...
                <div class="py-4 lg:py-6">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm lg:text-base text-gray-600 mt-1">Información completa de {{ $pet->nombre }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
                    ...
                    <div class="relative group">
                        ...
                        <form action="{{ route('dashboard.cliente.mascotas.update-image', $pet) }}" method="POST" enctype="multipart/form-data" class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            @csrf
                            @method('PUT')
                            <label for="profile_image" class="cursor-pointer bg-black bg-opacity-60 rounded-full p-3 hover:bg-opacity-80 transition-all">
                    ...
                    <div class="text-center lg:text-left flex-1">
                        ...
                        <div class="flex flex-wrap justify-center lg:justify-start gap-4 text-sm">
                            <div class="flex items-center bg-white rounded-lg px-3 py-2 shadow-sm border border-gray-200">
                                ...
                                <span class="font-medium text-gray-700">{{ $pet->edad_anios }} años, {{ $pet->edad_meses }} meses</span>
                            </div>
                            <div class="flex items-center bg-white rounded-lg px-3 py-2 shadow-sm border border-gray-200">
                                <svg class="w-4 h-4 mr-2 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <span class="font-medium text-gray-700">{{ $pet->sexo }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="{{ route('dashboard.cliente.mascotas.edit', $pet) }}" 
                           class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-sm">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
