                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                    @if($appointment->requested_datetime >= now()) bg-blue-100 text-blue-800
                        ...
                        <div class="px-6 py-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-lg font-medium text-gray-900">{{ $appointment->requested_datetime->format('d/m/Y') }}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-lg font-medium text-gray-900">{{ $appointment->requested_datetime->format('H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                            
                            <!-- Información del Veterinario -->
                            @if($appointment->veterinarian || $appointment->location)
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-lg font-medium text-gray-900">{{ $appointment->veterinarian->name }}</span>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="space-y-4">
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500 mb-2">Diagnóstico/Tratamiento</h3>
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <p class="text-gray-900 whitespace-pre-wrap">{{ $appointment->diagnosis_treatment }}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
