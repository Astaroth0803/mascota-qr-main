            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="py-4 lg:py-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Administra tu información personal y profesional</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Tipo de Veterinario -->
                                <div>
                                    <label for="tipo_veterinario" class="block text-sm font-medium text-gray-700 mb-2">
                                        Tipo de veterinario
                                    </label>
                                    <select name="tipo_veterinario" id="tipo_veterinario" 
                                            class="block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tipo_veterinario') border-red-300 @enderror">
                                        <option value="">Selecciona tu tipo</option>
                                        @foreach($tiposVeterinarios as $value => $label)
                                            <option value="{{ $value }}" {{ old('tipo_veterinario', $user->tipo_veterinario) == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ubicacion" id="ubicacion" 
                                           ...
                                           placeholder="Ej: Clínica Veterinaria Central, Ciudad de Panamá"
                                           class="block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('ubicacion') border-red-300 @enderror">
                                    <p class="mt-2 text-xs text-gray-500">Esta ubicación se usará para llenar automáticamente las citas que crees</p>
                                    @error('ubicacion')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-xl p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <span class="text-gray-600 ml-2">{{ ucfirst($user->getRoleNames()->first()) }}</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <span class="font-medium text-gray-700">Mascotas asignadas:</span>
                                        <span class="text-gray-600 ml-2">{{ $user->mascotasActivas()->count() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="space-y-2 text-sm text-blue-800">
                            <p>• Tu tipo de veterinario se muestra a los clientes cuando solicitan tus servicios</p>
                            <p>• La ubicación se usará automáticamente al crear nuevas citas</p>
                            <p>• Los cambios en tu información personal se reflejan inmediatamente</p>
