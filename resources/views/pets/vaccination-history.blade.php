                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <!-- Información específica de vacuna -->
                                        @if($record->record_type == 'vacunacion' || $record->record_type == 'vacuna')
                                            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                                                <h4 class="text-sm font-medium text-green-900 mb-3">Información de la Vacuna</h4>
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    @if($record->nombre_tecnico)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Nombre Técnico</span>
                                                            <p class="text-sm text-green-900 font-medium">{{ $record->nombre_tecnico }}</p>
                                                        </div>
                                                    @endif
                                                    @if($record->nombre_comercial)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Nombre Comercial</span>
                                                            <p class="text-sm text-green-900 font-medium">{{ $record->nombre_comercial }}</p>
                                                        </div>
                                                    @endif
                                                    @if($record->laboratorio)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Laboratorio</span>
                                                            <p class="text-sm text-green-900 font-medium">{{ $record->laboratorio }}</p>
                                                        </div>
                                                    @endif
                                                    @if($record->lote)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Lote</span>
                                                            <p class="text-sm text-green-900 font-medium">{{ $record->lote }}</p>
                                                        </div>
                                                    @endif
                                                    @if($record->fecha_caducidad)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Fecha de Caducidad</span>
                                                            <p class="text-sm text-green-900 font-medium">
                                                                {{ $record->fecha_caducidad instanceof \Carbon\Carbon ? $record->fecha_caducidad->format('d/m/Y') : \Carbon\Carbon::parse($record->fecha_caducidad)->format('d/m/Y') }}
                                                            </p>
                                                        </div>
                                                    @endif
                                                    @if($record->fecha_expedicion)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Fecha de Expedición</span>
                                                            <p class="text-sm text-green-900 font-medium">
                                                                {{ $record->fecha_expedicion instanceof \Carbon\Carbon ? $record->fecha_expedicion->format('d/m/Y') : \Carbon\Carbon::parse($record->fecha_expedicion)->format('d/m/Y') }}
                                                            </p>
                                                        </div>
                                                    @endif
                                                    @if($record->fecha_aplicacion)
                                                        <div>
                                                            <span class="text-xs font-medium text-green-700 uppercase tracking-wide">Fecha de Aplicación</span>
                                                            <p class="text-sm text-green-900 font-medium">
                                                                {{ $record->fecha_aplicacion instanceof \Carbon\Carbon ? $record->fecha_aplicacion->format('d/m/Y') : \Carbon\Carbon::parse($record->fecha_aplicacion)->format('d/m/Y') }}
                                                            </p>
                                                        </div>
                                                    @endif
                                                </div>
