...
class AppointmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($user->hasRole('veterinario')) {
            ...
            return view('dashboard.veterinario.appointments.index', compact('appointments'));
        } else {
            ...
            return view('dashboard.cliente.appointments.index', compact('appointments'));
        }
    }
    ...
    public function create()
    {
        ...
        if ($user->hasRole('veterinario')) {
            ...
            return view('dashboard.veterinario.appointments.create', compact('assignedPets', 'recordTypes'));
        } else {
            ...
            return view('dashboard.cliente.appointments.create', compact('pets', 'veterinarians', 'recordTypes'));
        }
    }
