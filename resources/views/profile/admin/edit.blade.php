            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="py-4 lg:py-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Administra tu información personal y configuración de administrador</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-gray-600 ml-2">{{ $user->getAllPermissions()->count() }} permisos</span>
                                    </div>
                                </div>
                            </div>
                        </div>
