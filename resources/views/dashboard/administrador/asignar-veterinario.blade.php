                ...
                <div class="py-4 lg:py-6">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            <h1 class="text-xl lg:text-2xl xl:text-3xl font-bold text-gray-900">Asignar Veterinario</h1>
                            <p class="text-sm lg:text-base text-gray-600 mt-1">Gestiona las asignaciones de veterinarios a mascotas</p>
                        </div>
