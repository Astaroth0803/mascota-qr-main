...
@php
    $title = 'Solicitar Nueva Mascota';
    $subtitle = 'Completa la información de tu mascota para solicitar su registro';
@endphp
...
<div class="w-full">
    <!-- Header Principal -->
    <div class="mb-6">
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Solicitar Nueva Mascota</h1>
    ...
    <div class="w-full">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-8">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-300">Proceso de Solicitud</h3>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Información de la Mascota</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Proporciona los datos básicos de tu mascota</p>
            </div>
