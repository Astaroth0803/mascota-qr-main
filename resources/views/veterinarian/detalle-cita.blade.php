...
<div>
    ...
    <div class="flex items-center justify-end mb-6">
        <div class="flex items-center space-x-2">
            ...
            @else
                <div class="inline-flex items-center px-3 py-2 bg-gray-400 text-white text-sm font-medium rounded-xl cursor-not-allowed">
                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-2 mt-2">
                                    ...
                                    @elseif($appointment->status === 'aceptado' && $appointment->scheduled_datetime && $appointment->scheduled_datetime->isToday())
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            Hoy
                                        </span>
                                    @elseif($appointment->status === 'aceptado' && $appointment->scheduled_datetime && $appointment->scheduled_datetime->isFuture())
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                            Próxima
                                        </span>
                                    @elseif($appointment->status === 'aceptado')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-lg font-semibold text-gray-900">{{ $appointment->scheduled_datetime ? $appointment->scheduled_datetime->format('d/m/Y') : $appointment->requested_datetime->format('d/m/Y') }}</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-lg font-semibold text-gray-900">{{ $appointment->scheduled_datetime ? $appointment->scheduled_datetime->format('H:i') : $appointment->requested_datetime->format('H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-lg font-semibold text-gray-900">{{ $appointment->veterinarian->name ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <div class="p-6">
                                    <div class="p-4 bg-red-50 rounded-xl">
                                        <p class="text-gray-700 whitespace-pre-wrap">{{ $appointment->diagnosis_treatment }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
