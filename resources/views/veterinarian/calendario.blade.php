...
<div class="w-full" x-data="calendarioVeterinario()">
    <!-- Header con acciones -->
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Mi Calendario</h1>
            <p class="text-gray-600 dark:text-gray-300 mt-1">Gestiona las citas médicas de tus mascotas</p>
        </div>
        
        <!-- Acciones rápidas -->
        <div class="flex items-center space-x-2">
            <a href="{{ route('dashboard.veterinario.calendario.today') }}" 
               class="inline-flex items-center px-3 py-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 text-sm font-medium rounded-xl hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
            ...
            <a href="{{ route('dashboard.veterinario.calendario.create') }}" 
               class="inline-flex items-center px-3 py-2 bg-blue-600 dark:bg-blue-700 text-white text-sm font-medium rounded-xl hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors">
                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['total_appointments'] }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Próximas</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['upcoming_count'] }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Completadas</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['past_count'] }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Mascotas</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['assigned_pets_count'] }}</p>
                        </div>
    ...
    <div class="mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-1">
            <nav class="flex space-x-1">
                <button @click="activeTab = 'upcoming'" 
                        :class="activeTab === 'upcoming' ? 'bg-blue-600 dark:bg-blue-700 text-white shadow-sm' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700'"
                ...
                <button @click="activeTab = 'past'" 
                        :class="activeTab === 'past' ? 'bg-blue-600 dark:bg-blue-700 text-white shadow-sm' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700'"
                        class="flex-1 flex items-center justify-center px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
            ...
            <div class="space-y-4">
                ...
                <div x-show="activeTab === 'upcoming'" class="space-y-4">
                    @forelse($upcomingAppointments as $appointment)
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 mb-4 hover:shadow-md dark:hover:shadow-lg transition-all duration-200">
                                ...
                                <div class="flex items-start space-x-3 flex-1 min-w-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center space-x-2 mb-2">
                                            <h3 class="text-base font-semibold text-gray-900 dark:text-white truncate">{{ $appointment->pet->nombre }}</h3>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 flex-shrink-0">
                                                {{ ucfirst($appointment->record_type) }}
                                            </span>
                                        </div>
                                        <div class="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                                            <div class="flex items-center">
                                                <svg class="w-3.5 h-3.5 mr-1.5 text-gray-400 dark:text-gray-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                                </svg>
                                                <span class="font-medium">@if($appointment->scheduled_datetime)
    {{ $appointment->scheduled_datetime->format('d/m/Y') }} a las {{ $appointment->scheduled_datetime->format('H:i') }}
@else
    Fecha no programada
@endif</span>
                                ...
                                <div class="flex items-start space-x-3 flex-1 min-w-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            @if(in_array($appointment->status, ['finalizada', 'completada', 'cita_terminada']))
                                            ...
                                            @elseif($appointment->status === 'rechazado')
