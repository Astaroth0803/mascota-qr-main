...
@php
    ...
    $subtitle = 'Información completa de la solicitud de mascota';
@endphp
...
<div class="w-full">
    ...
    <div class="w-full">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">{{ $petRequest->nombre }}</h2>
            ...
            <!-- Acciones -->
            <div class="px-6 py-6 bg-blue-50 dark:bg-gray-700 border-t border-blue-200 dark:border-gray-600">
                <h3 class="text-lg font-medium text-blue-900 dark:text-white mb-4">Acciones</h3>
                <div class="flex flex-col sm:flex-row gap-4">
                    <!-- Botón de regreso -->
                    <a href="{{ route('pet-requests.index') }}" 
                       class="inline-flex items-center justify-center px-4 py-2 bg-gray-600 dark:bg-gray-700 text-white text-sm font-medium rounded-lg hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors">
