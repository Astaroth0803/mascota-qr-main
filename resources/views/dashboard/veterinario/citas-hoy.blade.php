...
@section('title', 'Citas de Hoy - Veterinario')
            ...
            <div class="py-4 lg:py-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1 min-w-0">
                        <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Citas de Hoy</h1>
                        <p class="text-sm text-gray-600 mt-1">{{ now()->format('l, d \d\e F \d\e Y') }}</p>
                    </div>
                    <!-- Acciones rápidas -->
