    ...
    public function updatePassword(Request $request, $id)
{
    ...
    {
        $usuario = User::findOrFail($id);
        return view('requests.edit-password', compact('usuario'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('requests.usuarios', compact('usuarios'));
    }
    ...
    public function create()
    {
        ...
        return view('requests.create-user', compact('roles')); // Pasar los roles a la vista
    }
