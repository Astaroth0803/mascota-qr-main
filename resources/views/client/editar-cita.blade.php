            ...
            <div class="py-4 lg:py-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('dashboard.cliente.calendario.index') }}" 
                       class="inline-flex items-center justify-center px-4 py-2 bg-gray-500 text-white text-sm font-medium rounded-lg hover:bg-gray-600 transition-colors">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span class="text-blue-600">{{ $appointment->requested_datetime->format('d/m/Y') }}</span>
                        </div>
                        <div>
                            <span class="font-medium text-blue-700">Hora actual:</span>
                            <span class="text-blue-600">{{ $appointment->requested_datetime->format('H:i') }}</span>
                        </div>
                    </div>
                </div>
