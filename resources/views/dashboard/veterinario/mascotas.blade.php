            ...
            <div class="py-4 lg:py-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1 min-w-0">
                        <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Mis Mascotas</h1>
                        <p class="text-sm text-gray-600 mt-1">Gestiona las mascotas bajo tu cuidado veterinario</p>
                    </div>
                    <!-- Acciones rápidas -->
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="flex gap-2">
                        <select class="px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
                            ...
                            <div class="flex items-center space-x-4 mb-4">
                                <div class="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                                    @if($mascota->profile_image)
                                        <img src="{{ Storage::url($mascota->profile_image) }}" alt="{{ $mascota->nombre }}" class="w-full h-full object-cover rounded-2xl">
                                    @else
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('dashboard.veterinario.mascota.show', $mascota) }}" 
                                   class="flex-1 inline-flex items-center justify-center px-3 py-2.5 border border-gray-200 text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('dashboard.veterinario.historial', $mascota) }}" 
                                   class="flex-1 inline-flex items-center justify-center px-3 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors">
                                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @else
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">No hay mascotas asignadas</h3>
                        <p class="text-gray-500 mb-6">Contacta al administrador para que te asigne mascotas.</p>
