...
@section('title', 'Nueva Cita - Veterinario')
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 pt-16 lg:pt-0">
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="py-4 lg:py-6">
                <div class="mb-4">
                    <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Programar Nueva Cita</h1>
                    <p class="text-sm text-gray-600 mt-1">Crea una nueva cita médica para tus mascotas asignadas</p>
                </div>
            </div>
        </div>
    </div>
