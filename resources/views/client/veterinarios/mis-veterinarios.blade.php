...
@section('title', 'Mis Veterinarios')

@php
    $title = 'Mis Veterinarios';
    $subtitle = 'Gestiona los veterinarios asignados a tus mascotas';
@endphp
...
<div class="w-full">
    <!-- Header Principal -->
    <div class="mb-6">
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Mis Veterinarios</h1>
        <p class="text-gray-600 mt-1">Gestiona los veterinarios asignados a tus mascotas</p>
    </div>
